...
const citizenSchema = new Schema(
  {
    ...
    temporaryResidenceFrom: { type: Date },
    temporaryResidenceTo: { type: Date },
    temporaryAbsenceAddress: { type: String, trim: true },
    temporaryAbsenceFrom: { type: Date },
    temporaryAbsenceTo: { type: Date },
