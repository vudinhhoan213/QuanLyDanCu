...
// Special actions
router.post('/:id/approve', authenticate, isLeader, rewardProposalController.approve);
router.post('/:id/reject', authenticate, isLeader, rewardProposalController.reject);
